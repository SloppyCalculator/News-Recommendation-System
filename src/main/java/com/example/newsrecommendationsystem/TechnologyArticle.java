...
public class TechnologyArticle extends AbstractArticle {
    private final String apiURL = "https://newsapi.org/v2/everything?language=en&q=technology";
    public TechnologyArticle(String title, String author, String description, String url, Date publishedAt, String content, String source) {
    ...
    private AbstractArticle parseArticleFromJson(JSONObject jsonArticle) {
        ...
        return new TechnologyArticle(title, author, description, url, publishedAt, content, source);
    }
