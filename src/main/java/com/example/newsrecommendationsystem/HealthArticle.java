...
public class HealthArticle extends AbstractArticle {
    private String apiURL = "https://newsapi.org/v2/everything?language=en&q=health";
    public HealthArticle(String title, String author, String description, String url, Date publishedAt, String content, String source) {
    ...
    private AbstractArticle parseArticleFromJson(JSONObject jsonArticle) {
        ...
        return new HealthArticle(title, author, description, url, publishedAt, content, source);
    }
