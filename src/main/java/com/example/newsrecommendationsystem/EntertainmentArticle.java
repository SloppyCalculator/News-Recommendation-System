...
public class EntertainmentArticle extends AbstractArticle {
    private String apiURL = "https://newsapi.org/v2/everything?language=en&q=entertainment";

    public EntertainmentArticle(String title, String author, String description, String url, Date publishedAt, String content, String source) {
    ...
    private AbstractArticle parseArticleFromJson(JSONObject jsonArticle) {
        ...
        return new EntertainmentArticle(title, author, description, url, publishedAt, content, source);
    }
}
